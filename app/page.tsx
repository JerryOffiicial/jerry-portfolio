...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section id="projects" className="flex min-h-[100vh] w-full items-center justify-center p-24">
         <div className="text-center">
          <h2 className="text-4xl font-bold tracking-tight mb-4">Projects Section</h2>
